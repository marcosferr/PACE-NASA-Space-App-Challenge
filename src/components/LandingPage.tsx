        ...
        <main>
            ...
            <section className='flex flex-col items-center gap-y-10'>
                <div className='flex flex-col items-center gap-y-2'>
                    <h1 className="text-7xl  font-black tracking-tight  text-green-700">ARANDU PACE</h1>
                    <p className='textxl font-normal'> Arandu means <i>the wisdom rooted in nature</i></p>
                    <h2 className='text-2xl font-normal text-green-950'>Plankton, Aerosol, Cloud, ocean Ecosystem </h2>
                </div>
                <img src="./pace-space.webp" alt="A picture of the pace spacecraft" className='rounded-lg w-1/3' />
                    <a href="/app" className='bg-zinc-950 border border-green-950 text-white rounded-md w-1/3 text-center py-2 hover:brightness-150 transition-all ease-in-out duration-300'>✨ Start Learning</a>
